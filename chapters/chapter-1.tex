...
\begin{enumerate}[noitemsep]
	...
	\item Model yang digunakan dibatasi pada arsitektur Vision Transformer (ViT) untuk pendekatan spasial dan VideoMAE untuk pendekatan spasiotemporal, dengan memanfaatkan bobot pralatih (\textit{pretrained weights}) untuk proses \textit{fine-tuning}.
