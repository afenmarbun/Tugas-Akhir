...
\begin{enumerate}[noitemsep]
	...
	\item Penelitian ini tidak mencakup perancangan atau pengembangan aplikasi maupun antarmuka pengguna, serta tidak membahas implementasi sistem dalam skenario \textit{real-time}, integrasi dengan data audio atau teks, dan pengujian pada dataset eksternal selain WildDeepfake.
\end{enumerate}
