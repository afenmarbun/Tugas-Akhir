...
Untuk mendukung analisis terhadap penurunan performa tersebut, kurva \textit{training loss} dan \textit{validation loss} pada eksperimen \textit{learning rate} 5e-4 ditunjukkan pada Gambar~\ref{fig:4.ablation-lr-loss-spatial} dan Gambar~\ref{fig:4.ablation-lr-loss-spatiotemporal}.
