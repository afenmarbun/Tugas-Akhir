...
\addbibresource{references.bib} % Import list Daftar Pustaka
...
\begin{document}
    ...
    \title{Analisis Komparatif Pendekatan Spasial dan Spasiotemporal untuk Klasifikasi Video Deepfake Menggunakan Vision Transformer dan VideoMAE}
    % Judul Tugas Akhir dalam Bahasa Inggris
    \titleEN{Comparative Analysis of Spatial and Spatiotemporal Approaches for Deepfake Video Classification Using Vision Transformer and VideoMAE}
    % JUDUL AKAN DITULIS DALAM HURUF KAPITAL; Font size 16 pt; Bold; Tidak melebihi 4 baris
    
    % Informasi Mahasiswa
	\author{Rustian Afencius Marbun}		% Nama Mahasiswa
	\nim{122140155}				% NIM Mahasiswa
	...
	\pengujiA%
		{Hafiz Budi Firmansyah S.Kom., M.Sc., Ph.D.}%				% Nama Dosen Penguji 1
		{NIP. 19910824 201903 1 014}	% NIP Dosen Penguji 1
	\pengujiB%
		{Rahman Indra Kesuma, S.Kom., M.Cs.}%				% Nama Dosen Penguji 2
		{NIP. 19910530 201903 1 018}	% NIP Dosen Penguji 2
	...
	\input{chapters/approval} 		% Lembar Pengesahan (dinonaktifkan untuk seminar proposal)
    %----------------------------------------------------------------%
	...
	% Lampiran dinonaktifkan sesuai permintaan.
\end{document}
