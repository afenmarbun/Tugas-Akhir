...
\begin{document}
    ...
    \title{Analisis Komparatif Pendekatan Spasial dan Spasiotemporal untuk Klasifikasi Video Deepfake Menggunakan ViT dan Encoder VideoMAE}
    % Judul Tugas Akhir dalam Bahasa Inggris
    \titleEN{Comparative Analysis of Spatial and Spatiotemporal Approaches for Deepfake Video Classification Using ViT and VideoMAE Encoder}
